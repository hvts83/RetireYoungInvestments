        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <fieldset class="form-horizontal">
                    <form role="form" method="post" action="{{ url('admin/akademy/retire/' . $retire->id ) }}">
                        {{ csrf_field() }}
                        ...
                        <div>
                            ...
                            <a class="btn btn-danger m-t-n-xs" href="{{ url('admin/akademy/retire/cancel/' . $retire->id ) }}">Cancelar solicitud</a>
                        </div>
                        @endif
                    </form>
                </fieldset>
